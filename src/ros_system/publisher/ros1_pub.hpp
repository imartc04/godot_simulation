...
private:
    ...
    CROSPubConfig<t_message_type> m_config;
...
public:
    ...
    void init()
    {
        ...
        if (m_config.proto_config.enabled() == true)
        {
            ...
            m_rate = ros::Rate(m_config.pub_rate);
